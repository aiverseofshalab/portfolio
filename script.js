class TerminalResume {
  constructor() {
    ...
    this.githubUsername = "aiverseofshalab";
    this.linkedinUsername = "aiverseofshalab";

    this.resumeFile = "assets/Shalab_Kumar_Shrivastava_Resume.pdf";

    this.portfolioData = {
    name: "Shalab Kumar Shrivastava",
    role: "Software Engineer | Python Developer | AI Engineer",
    education: "B.Tech CSE (IoT), GGITS Jabalpur",
    location: "Jabalpur, Madhya Pradesh, India",
    email: "aiverseofshalab@gmail.com",
    github: "https://github.com/aiverseofshalab",
    linkedin: "https://linkedin.com/in/aiverseofshalab",
    stackoverflow:
        "https://stackoverflow.com/users/32930096/aiverseofshalab"
  };
 ...
 handleCommand(inputElement) {
  ...
  switch (cmd) {
    ...
    case "github":
      window.open("https://github.com/aiverseofshalab", "_blank");
      this.printToOutput(outputElement, "Opening GitHub...", "info");
      break;

    case "linkedin":
      window.open("https://www.linkedin.com/in/aiverseofshalab", "_blank");
      this.printToOutput(outputElement, "Opening LinkedIn...", "info");
      break;
...
`;
  ...
  const welcome =
    ...
    this.wrapWithColor(
      "Python Developer • AI Engineer • Software Developer\n",
      "#87ceeb"
    ) +
    this.wrapWithColor(divider + "\n\n", "#666666") +
    this.wrapWithColor("Welcome to my interactive terminal portfolio.\n\n", "#ffffff") +
    this.wrapWithColor("Type ", "#aaaaaa") +
    this.wrapWithColor("'help'", "#00ff00") +
    this.wrapWithColor(" to view all available commands.\n", "#aaaaaa") +
    this.wrapWithColor("Press ", "#aaaaaa") +
    this.wrapWithColor("'Tab'", "#00ff00") +
    this.wrapWithColor(" for command auto-completion.", "#aaaaaa");
  ...
  "         " +
  this.wrapWithColor("Show all commands\n", "#ffffff") +

  this.wrapWithColor("• about", "#98fb98") +
  "        " +
  this.wrapWithColor("About me\n", "#ffffff") +

  this.wrapWithColor("• skills", "#98fb98") +
  "       " +
  this.wrapWithColor("Technical skills\n", "#ffffff") +

  this.wrapWithColor("• experience", "#98fb98") +
  "   " +
  this.wrapWithColor("Work experience\n", "#ffffff") +

  this.wrapWithColor("• education", "#98fb98") +
  "    " +
  this.wrapWithColor("Education details\n", "#ffffff") +

  this.wrapWithColor("• projects", "#98fb98") +
  "     " +
  this.wrapWithColor("Featured projects\n", "#ffffff") +

  this.wrapWithColor("• contact", "#98fb98") +
  "      " +
  this.wrapWithColor("Contact information\n", "#ffffff") +

  this.wrapWithColor("• github", "#98fb98") +
  "       " +
  this.wrapWithColor("Open GitHub profile\n", "#ffffff") +

  this.wrapWithColor("• linkedin", "#98fb98") +
  "     " +
  this.wrapWithColor("Open LinkedIn profile\n", "#ffffff") +

  this.wrapWithColor("• resume", "#98fb98") +
  "       " +
  this.wrapWithColor("Download resume\n", "#ffffff") +

  this.wrapWithColor("• pdf", "#98fb98") +
  "          " +
  this.wrapWithColor("Download PDF\n", "#ffffff") +

  this.wrapWithColor("• theme", "#98fb98") +
  "        " +
  this.wrapWithColor("Change theme\n", "#ffffff") +

  this.wrapWithColor("• clear", "#98fb98") +
  "        " +
  this.wrapWithColor("Clear terminal\n", "#ffffff");

    const utilityCommands =
  "\n" +
  this.wrapWithColor("Useful Commands:\n", "#00ffff") +
  this.wrapWithColor("• github", "#98fb98") +
  "       " +
  this.wrapWithColor("Open GitHub\n", "#ffffff") +
  this.wrapWithColor("• linkedin", "#98fb98") +
  "     " +
  this.wrapWithColor("Open LinkedIn\n", "#ffffff") +
  this.wrapWithColor("• resume", "#98fb98") +
  "       " +
  this.wrapWithColor("Download Resume\n", "#ffffff") +
  this.wrapWithColor("• pdf", "#98fb98") +
  "          " +
  this.wrapWithColor("Resume PDF\n", "#ffffff") +
  this.wrapWithColor("• theme", "#98fb98") +
  "        " +
  this.wrapWithColor("Switch Theme\n", "#ffffff");
...
const shortcuts =
  ...
  "      " +
  this.wrapWithColor("History\n", "#ffffff") +
  this.wrapWithColor("Tab", "#98fb98") +
  "         " +
  this.wrapWithColor("Auto Complete\n", "#ffffff") +
  this.wrapWithColor("Ctrl + L", "#98fb98") +
  "    " +
  this.wrapWithColor("Clear Terminal\n", "#ffffff");
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "B.Tech CSE student (IoT, Cybersecurity & Blockchain)",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "building with Python, Flask, and LLM APIs.",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
  "   Building scalable backends and AI-powered agents using",
  "#ffffff"
)}
${this.wrapWithColor("   Python, Flask, Django, FastAPI, and LLM APIs", "#ff8c00")}
...
<span style="color: #00ffff;">AIALCHEMIST | Chief Marketing Officer</span>
${this.wrapWithColor(
  "2025 - Present | Jabalpur, India (Remote) | Student-led AI startup",
  "#ffffff"
)}
${this.wrapWithColor(
  "Driving product positioning and growth for an AI-focused startup",
  "#98fb98"
)}

• ${this.wrapWithColor("Product marketing", "#ffa07a")} - ${this.wrapWithColor(
      "Own positioning, messaging, and growth strategy.",
      "#ffffff"
    )}
• ${this.wrapWithColor(
      "Cross-functional",
      ...
      "Stay hands-on with the technical side of what we build",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Python, Flask, LLM APIs (Groq, OpenAI, Claude, Gemini)",
      "#87cefa"
    )}

<span style="color: #00ffff;">CODSOFT | Web Development Intern</span>
${this.wrapWithColor(
  "2024 | Remote Internship",
  "#ffffff"
)}

• ${this.wrapWithColor("Web development", "#ffa07a")} - ${this.wrapWithColor(
      "Built and shipped web features as part of an internship program.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Hands-on delivery", "#ffa07a")} - ${this.wrapWithColor(
      "First real experience shipping deployed code.",
      "#ffffff"
    )}
...
<span style="color: #00ffff;">OPEN SOURCE | Contributor</span>
${this.wrapWithColor(
  "2025 - Present | Remote",
  "#ffffff"
)}
...
• ${this.wrapWithColor("Contributions", "#ffa07a")} - ${this.wrapWithColor(
      "Contributing code and fixes to open-source projects.",
      "#ffffff"
    )}

<span style="color: #00ffff;">CAMPUS AMBASSADOR | AWS · GDG · AnitaB.org</span>
${this.wrapWithColor(
  "2025 | GGITS, Jabalpur",
  "#ffffff"
)}
...
• ${this.wrapWithColor("Community building", "#ffa07a")} - ${this.wrapWithColor(
      "Represented cloud and dev communities on campus, organizing workshops and events.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "AWS, Git, GitHub, Community Ops",
      "#87cefa"
    )}`;
...
showSkills(outputElement = this.output) {
  ...
  const skills = `
<span style="color:#ffff00;font-weight:bold;">🛠️ TECH STACK</span>
...
<span style="color:#00ffff;">Database</span>
• MySQL
• MongoDB
• PostgreSQL
...
<span style="color:#00ffff;">Currently Learning</span>
• System Design
• Data Structures & Algorithms
• Cloud Computing
`;

  this.printToOutput(outputElement, skills, "info");
}
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:aiverseofshalab@gmail.com" style="color: #ffffff; text-decoration: none;">aiverseofshalab@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://aiverseofshalab.github.io" target="_blank" style="color: #ffffff; text-decoration: none;">aiverseofshalab.github.io</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/aiverseofshalab" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/aiverseofshalab</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/aiverseofshalab" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/aiverseofshalab</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      {
        title: "AI-Powered IR Survey Agent",
        description: "End-to-end automated pipeline for outbound survey calls with a real-time conversational AI flow.",
        image: "path/to/project-image.jpg",
        technologies: ["Next.js", "Node.js", "Supabase", "Twilio"],
        demo: "https://github.com/aiverseofshalab/Call-Agent",
        repo: "https://github.com/aiverseofshalab/Call-Agent",
      },
      {
        title: "Agentic AI Calling System",
        description: "Reads contacts from Excel, places sequential AI voice calls, and shows live results on a dashboard.",
        image: "path/to/project-image.jpg",
        technologies: ["Flask", "Twilio", "SQLite"],
        demo: "https://github.com/aiverseofshalab",
        repo: "https://github.com/aiverseofshalab",
      },
      {
        title: "Smart Disaster Management System",
        description: "Real-time disaster alert system with offline SOS, hospital locator, and emergency transport integration.",
        image: "path/to/project-image.jpg",
  ...
  async generatePDF() {
    const outputElement = this.terminals[this.activeTerminal].input
      .closest(".terminal-content")
      .querySelector("[id^='output']");
    this.printToOutput(outputElement, "Preparing resume PDF...", "info");

    setTimeout(() => {
      const link = document.createElement("a");
      link.href = this.resumeFile;
      link.download = "Shalab_Kumar_Shrivastava_Resume.pdf";
      ...
      this.printToOutput(
        outputElement,
        `Download started. If nothing happened, grab it directly here: <a href="${this.resumeFile}" target="_blank" style="color: #66d9ef; text-decoration: underline;">${this.resumeFile}</a>`,
        "success"
      );
    }, 600);
  }
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "shalab@shrivastava: ~/interactive-resume";
...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═════╝ `;
    ...
    role.textContent = "Python Developer • AI Engineer • CSE Student";
    ...
    url.textContent = "aiverseofshalab.me";
